...
from race_msgs.msg import PursuitLocation, PursuitLocationPixel
...
class HomographyTransformer(Node):
    def __init__(self):
        ...
        self.cone_pub = self.create_publisher(PursuitLocation, "/relative_cone", 10)
        ...
        self.cone_px_sub = self.create_subscription(PursuitLocationPixel, "/relative_cone_px", self.cone_detection_callback, 1)
    ...
    def cone_detection_callback(self, msg):
        ...
        relative_xy_msg = PursuitLocation()
