...
from race_msgs.msg import PursuitLocation, PursuitError
...
class ParkingController(Node):
    ...
    def __init__(self):
        ...
        self.error_pub = self.create_publisher(PursuitError, "/parking_error", 10)

        self.create_subscription(PursuitLocation, "/relative_cone", 
